...
export const ListItemDetail = ({ car }: { car: Car }) => {
  ...
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-6 py-4 text-sm text-slate-500">{car.startDateTime}</td>
      <td className="px-6 py-4 text-sm text-slate-500">{car.endDateTime}</td>
      <td className="px-6 py-4">
        <div
